...
LG_CONFTEST_TYPE_COMPILE_TESTS += pwm_remove_table
...
LG_CONFTEST_TYPE_COMPILE_TESTS += drm_sched_job_has_id
...
LG_CONFTEST_TYPE_COMPILE_TESTS += get_kernel_page_size_4k
LG_CONFTEST_TYPE_COMPILE_TESTS += get_kernel_page_size_16k
LG_CONFTEST_TYPE_COMPILE_TESTS += turn_on_lvds
LG_CONFTEST_TYPE_COMPILE_TESTS += turn_off_lvds
